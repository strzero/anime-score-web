...
export default async function now() {
    ...
    Object.keys(data).forEach(key => {
        ...
        ave_data.push({
            id: key,
            name: bangumiData.id,
            bangumi: bangumiData.name_cn || bangumiData.name,
            myanimelist: scoreData.myanimelist.title,
            anilist: scoreData.anilist.title,
            filmarks: scoreData.filmarks.title,
            anikore: scoreData.anikore.title,
